        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: "#5a7a9a" }}>
              МедиКлиника — специализированный наркологический центр, основанный в 2004 году. Мы предлагаем полный спектр услуг по лечению алкогольной и наркотической зависимости на основе доказательной медицины.
            </p>
